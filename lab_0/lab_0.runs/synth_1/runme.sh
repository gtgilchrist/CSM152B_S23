...
HD_PWD='C:/Users/Student/Documents/GitHub/CSM152B_S23/lab_0/lab_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_counter.tcl
