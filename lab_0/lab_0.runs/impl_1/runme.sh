...
HD_PWD='C:/Users/Student/Documents/GitHub/CSM152B_S23/lab_0/lab_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_counter.tcl -notrace
